...
ULIB = $U/ulib.o $U/usys.o $U/printf.o $U/umalloc.o $U/auth.o
...
fs.img: $T/mkfs README passwd group motd issue $(UPROGS)
	$T/mkfs fs.img README passwd group motd issue $(UPROGS)
